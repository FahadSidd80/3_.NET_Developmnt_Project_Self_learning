<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageRecruiter_Admin.ascx.cs" Inherits="JobPortal.Content.Admin.ManageRecruiter_Admin" %>



<table   style="text-align:center">
    <tr>
        <td><h1>Manage Recruiter <asp:Label ID="lblrecruitermsg" runat="server"></asp:Label></h1></td>
    </tr>
</table>
<table>
    <tr>
